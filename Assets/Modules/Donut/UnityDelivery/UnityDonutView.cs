...
namespace Modules.Donut.UnityDelivery
{
    public class UnityDonutView : MonoBehaviour
    {
        ...
        [SerializeField] private MeshRenderer donutMesh;
        ...
        public void Init(Material donutMaterial, Material glassMaterial)
        {
            donutMesh.sharedMaterial = donutMaterial;
            glassMesh.sharedMaterial = glassMaterial;
        }
