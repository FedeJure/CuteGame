...
public class Banner: MonoBehaviour
{
    ...
    string gameId = "4911293";
    public static int size;

    private void Awake()
    {
        size = BannerAdPredefinedSize.Banner.ToBannerAdSize().DpHeight;
    }
    ...
    {
        //Create
        ad = MediationService.Instance.CreateBannerAd(adUnitId,  BannerAdPredefinedSize.Banner.ToBannerAdSize(), BannerAdAnchor.TopCenter, Vector2.zero);
        //Subscribe to events
